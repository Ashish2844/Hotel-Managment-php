...
<div class="ad_form">
  ...
  <input type="hidden" value="'.$output['id'].'" name="idr">
  <br/>
  <br/>
    <label>Select Room:</label>
   <select name="rselect" id="">
   ...
   <br/>
   <br/>
   <label>Enter number of rooms to remove:</label>
   <input type="text"  name="rrooms" required>
   <br/>
   <br/>
   <input type="submit" value="Remove" name="remove_room">
